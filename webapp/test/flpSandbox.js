		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoicesv2",
									"targetURL": "#invoicesv2invoicesv2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"invoicesv2invoicesv2-display": {
								"semanticObject": "invoicesv2invoicesv2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=invoicesv2.invoicesv2",
									"url": sap.ui.require.toUrl("invoicesv2/invoicesv2")
								}
							}
						}
					}
